...
FOR i = 1 TO 2
        ...
        SPEED 18
        MOVE G6A,  89,  69, 151,  97, 110,
        MOVE G6D,  88,  67, 147, 101, 111,
        MOVE G6B, 101,  99, 102,  ,  ,
        ...
        SPEED 12
        MOVE G6A,  91, 129, 102,  85, 109,
        MOVE G6D,  88, 100,  86, 129, 111,
        MOVE G6B, 189, 104,  99,  ,  ,
        MOVE G6C, 187,  99,  99,  ,  ,
        WAIT
        ...
        MOVE G6A,  89,  69, 151,  97, 110,
        MOVE G6D,  88,  67, 147, 101, 111,
        MOVE G6B, 100, 169,  99,  ,  ,150
        MOVE G6C,  99, 169, 102,  ,  ,
        WAIT
        DELAY 100 '第三拍

        SPEED 15
        MOVE G6A,  94,  75, 133, 112, 105,
        MOVE G6D,  97,  77, 131, 112, 101,
        MOVE G6B, 100, 169,  99,  ,  ,
        MOVE G6C,  99, 169, 102,  ,  ,
        WAIT
        ...
        SPEED 12
        MOVE G6D,  91, 129, 102,  85, 109,
        MOVE G6A,  88, 100,  86, 129, 111,
        MOVE G6B, 189, 104,  99,  ,  ,
        MOVE G6C, 187,  99,  99,  ,  ,
        WAIT
...
NEXT A
 ...
 SPEED 12
        ...
        SPEED 12
        MOVE G6A,  89,  82, 122, 114, 118,
        MOVE G6D, 109,  75, 143,  98,  94,
        MOVE G6B, 100,  30,  80,  ,  ,
        MOVE G6C, 100,  30,  80,  ,  ,
        WAIT
        ...
        MOVE G6A,  89,  69, 151,  97, 110,
        MOVE G6D,  88,  67, 147, 101, 111,
        MOVE G6B, 109, 190, 142,  ,  ,
        MOVE G6C,  87, 190, 153,  ,  ,
        WAIT
        DELAY 100 '第一拍

        SPEED 10
        MOVE G6A,  91,  62, 127, 163, 110,
        MOVE G6D,  93,  67, 123, 165, 111,
        MOVE G6B, 176,  10,  48,  ,  ,
        MOVE G6C, 155,  10,  46,  ,  ,
        WAIT
        DELAY 100 '第二拍
        ...
        SPEED 8
        MOVE G6A, 102, 131,  26, 161,  97,
        MOVE G6D, 101, 129,  27, 162,  97,
        MOVE G6B, 157,  32,  15,  ,  ,
        MOVE G6C, 160,  42,  10,  ,  ,
        WAIT
        DELAY 100 '第三拍
        ...
        SPEED 12
        MOVE G6A, 109,  75, 143,  98,  99,
        MOVE G6D,  89,  82, 122, 114, 108,
        MOVE G6B, 100,  30,  80,  ,  ,
        MOVE G6C, 100,  30,  80,  ,  ,
        WAIT

        SPEED 12
        MOVE G6D,  89,  69, 151,  97, 110,
        MOVE G6A,  88,  67, 147, 101, 111,
        MOVE G6B, 109, 190, 142,  ,  ,
        MOVE G6C,  87, 190, 153,  ,  ,
        WAIT
        DELAY 100 '第一拍
